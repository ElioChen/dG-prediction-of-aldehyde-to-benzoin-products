# GNN+tabular stacking promoted to full-library scoring (20260713)
...
- Output: `products_dG_corrected_GNNSTACK_w40_20260713.csv` (`dG_blend_final` is the new best-estimate column;
...
- Sanity check on the full labeled overlap (n=218,105, note this INCLUDES
  ...
  trustworthy number is the aligned-v2 test-set MAE above): tabular 5.135,
  GNN 5.153, blend 5.119.

**Recommendation:** use `products_dG_corrected_GNNSTACK_w40_20260713.csv`'s `dG_blend_final` as the new
