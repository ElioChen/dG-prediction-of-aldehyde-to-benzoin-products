#!/bin/bash
#SBATCH --job-name=rec1_b973c_int
...
#SBATCH --array=0-1998%200
#SBATCH --output=/gpfs/scratch1/shared/schen3/benzoin-dg-restored/data/cross_benzoin/rec1_prodgeom_recheck/chunks_intermediate/int_%A_%a.out
set -o pipefail
REPO=/gpfs/scratch1/shared/schen3/benzoin-dg-restored
PY=/home/schen3/venv/nhc-workflow/bin/python
SAMP="$REPO/data/cross_benzoin/rec1_prodgeom_recheck/rec1_b973c_intermediate_1999.csv"
OUTD="$REPO/data/cross_benzoin/rec1_prodgeom_recheck/chunks_intermediate"
mkdir -p "$OUTD"
...
mkdir -p "$SCR"
OUT="$OUTD/int_$(printf '%04d' "$ID").csv"
