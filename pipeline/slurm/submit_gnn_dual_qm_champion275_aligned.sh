#!/bin/bash
#SBATCH --job-name=gnn_aligned_champion275
...
#SBATCH --output=/scratch-shared/schen3/benzoin-dg/data/cross_benzoin/homo_v6/viz_gxtb_20260625/gnn_aligned_champion275_%j.out
...
echo "GNN+tabular ALIGNED stacking node=${SLURMD_NODENAME} gpu=${CUDA_VISIBLE_DEVICES} $(date)"
nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null
$PY -u "$REPO/pipeline/analysis/gnn_dual_qm_champion275_aligned.py"
rc=$?
