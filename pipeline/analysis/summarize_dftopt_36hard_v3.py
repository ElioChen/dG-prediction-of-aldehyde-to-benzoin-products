...
RES = ROOT / "data/raw/screen_v6/dft_sp_r2scan3c/dftopt_36hard_v3"
...
def main():
    ...
    L = [f"# Fair DFT-opt rerun on the 36 g-xTB-hard cases ({STAMP})\n",
         f"Job 24527962 (v3 full-36 resubmit, see dftopt_36hard_v2 stall) · r2SCAN-3c Opt TightSCF CPCM(DMSO).\n\n",
