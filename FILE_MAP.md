...
| `data/cross_benzoin/cross_pilot_v2/` | Follow-up scale-up (job 24609321, launched 2026-07-14, ample-CPU-budget-driven): 2,100 unordered / 4,200 directed pairs, disjoint from cross_pilot_v1 (`select_cross_pilot_sample.py --exclude-pairs-csv`), same 100%-cache-hit / product-only-compute design |
