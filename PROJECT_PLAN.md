...
- **Missing.** Step 6 only: point the redone cross AL / Goal-3 screening at
  ...
  implemented; a lazy-only absolute-target screener trained, then improved
  same-day by fixing a real gap (aldehyde Mordred wasn't joined into the
  lazy tier) — final MAE 2.994/R² 0.350 vs champion 0.528 / g-xTB-no-model
