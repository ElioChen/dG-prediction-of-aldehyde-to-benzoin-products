...
cd "$REPO"
echo "gnn_attentive_8rounds node=${SLURMD_NODENAME} gpu=${CUDA_VISIBLE_DEVICES} $(date)"
$PY -u cross_benzoin/train_cross_gnn_arch_sweep.py \
    --table data/cross_benzoin/cross_round8/cross_train_table_8rounds_scaffold_split_labeled_slim260.parquet \
    --champion-dir data/cross_benzoin/cross_round8/scaffold_disjoint_8rounds_v1 \
    --ensemble-path data/cross_benzoin/cross_round8/scaffold_disjoint_8rounds_v1/models/ensemble_scaffold_disjoint.joblib \
    --outdir data/cross_benzoin/cross_round8/gnn_attentive_8rounds_v1 \
