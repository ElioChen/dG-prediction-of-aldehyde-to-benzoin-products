#!/usr/bin/env python
"""
Re-derive pair-level scaffold-disjoint labels (new_scaffold_split) for the round1-9
...
Same derivation rule as round1-8's relabeling (relabel_scaffold_split_8rounds.py): a pair
is train/validation/test only if donor AND acceptor land in the same molecule-level
...
pairs = pd.read_parquet("data/cross_benzoin/cross_round9/cross_train_table_9rounds_mordred.parquet")
...
out = "data/cross_benzoin/cross_round9/cross_train_table_9rounds_scaffold_split_labeled.parquet"
