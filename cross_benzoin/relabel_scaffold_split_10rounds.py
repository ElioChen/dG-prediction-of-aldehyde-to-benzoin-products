#!/usr/bin/env python
"""
Re-derive pair-level scaffold-disjoint labels (new_scaffold_split) for the round1-10
...
out = "data/cross_benzoin/cross_round10/cross_train_table_10rounds_scaffold_split_labeled.parquet"
